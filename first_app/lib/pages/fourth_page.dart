...
class ProductItem {
  ...
  required this.name, required this.price, required this.colorShade});
}
   ...
   return GestureDetector(
     onTap: () {
       Navigator.push(context,
        MaterialPageRoute(
          builder: (context) => ProductDetial(item: item),
        ),
      );
     },
      child: Container(  
...
class ProductDetial extends StatelessWidget {
  ...
  const ProductDetial({Key? key, required this.item}) : super(key: key);
